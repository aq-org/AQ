...
**AQ** можно установить несколькими способами, включая компиляцию исходного кода и предварительно скомпилированные двоичные файлы. Конкретные шаги установки различаются в зависимости от платформы. Дополнительную информацию можно найти в [Руководстве по установке](installation.md).
...
Дополнительную информацию о **AQ** можно найти в <a href="/index.md">документации</a>.
...
Информацию можно найти в <a href="/standard.md">Языковых стандартах</a>.
